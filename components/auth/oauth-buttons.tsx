  ...
  return (
    <div className={`space-y-3 ${className}`}>
      <Button
        type="button"
        variant="outline"
        className="w-full h-12 bg-white/50 dark:bg-white/5 border-white/20 hover:bg-white/70 dark:hover:bg-white/10 transition-all duration-200"
...
/**
 * Divider component for separating OAuth from email/password forms
 */
